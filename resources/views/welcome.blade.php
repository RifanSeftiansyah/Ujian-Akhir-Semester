...
<div class="hero-image">
    <div class="hero-content">
        <div class="col-md-4 hero-text">
            <h3>
                Selamat Datang tokeyerss
            </h3>
            <p>Belanja apa saja tanpa khawatir biaya pengiriman! Dapatkan layanan gratis ongkir untuk setiap pembelian di tokOOnline. Lebih hemat, lebih praktis!</p>
...
<div class="container">
    <div class="content-head">
        <h2 style="text-align:center; font-weight: bold">tokOOnline</h2>
        <p style="text-align: center">Temukan berbagai produk berkualitas dan penawaran menarik hanya di tokOOnline. Kami hadir untuk memenuhi segala kebutuhan Anda dengan mudah dan cepat.</h2>
    </div>
